...
public class right_menu extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.form_user) {
            startActivity(new Intent(right_menu.this, form_user.class));
